...
//    CheckBox employee_check,employer_check;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = findViewById(R.id.employer_add_regesterbutton);
        name = findViewById(R.id.employer_add_name);
        email = findViewById(R.id.employer_add_email);
        phonenum = findViewById(R.id.employer_add_phone);
        password = findViewById(R.id.employer_add_password);
...
//                    Toast.makeText(Employer_addemployee.this,"Select the account type",Toast.LENGTH_SHORT).show();
//                }
                ...
                fAuth.createUserWithEmailAndPassword(mail,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {
                            Toast.makeText(Employer_addemployee.this, "User Created", Toast.LENGTH_SHORT).show();
...
//                            }
                            ...
                            Toast.makeText(Employer_addemployee.this, "Error ! "+ task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
