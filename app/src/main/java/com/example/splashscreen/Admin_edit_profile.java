...
public class Admin_edit_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ename = findViewById(R.id.admin_edit_profile_name);
        ephone = findViewById(R.id.admin_edit_profile_phoneno);
        epass = findViewById(R.id.admin_edit_profile_password);
        Save_button = findViewById(R.id.admin_save_edit_profile_button);
        change_profile_img = findViewById(R.id.admin_edit_profilepic);
        ...
        change_profile_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Admin_edit_profile.this, "Profile image clicked", Toast.LENGTH_SHORT).show();
        ...
        Save_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ename.getText().toString().isEmpty() || ephone.getText().toString().isEmpty()) {
                    Toast.makeText(Admin_edit_profile.this, "One or many fields are empty.", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(!ephone.getText().toString().matches("\\d{10}")){
                    Toast.makeText(Admin_edit_profile.this, "Phone no. is invalid", Toast.LENGTH_SHORT).show();
                    return;
                }
                            ...
                            if (documentSnapshot.getString("isAdmin") != null) {
                                ...
                                documentrefrence2.update(edited2).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(Admin_edit_profile.this, "Profile Updated", Toast.LENGTH_SHORT).show();
                                        startActivity(new Intent(getApplicationContext(), Admin_home.class));
                                        finish();
                                    }
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(Admin_edit_profile.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                            ;
    ...
    private void uploadImageToFirebase(Uri imguri) {
        ...
        fileRef.putFile(imguri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(Admin_edit_profile.this, "Image is uploaded", Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Admin_edit_profile.this, "Failed to upload", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        FirebaseAuth.getInstance().sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(Admin_edit_profile.this, "Password Reset Email Sent!", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(Admin_edit_profile.this, task.getException().getLocalizedMessage(), Toast.LENGTH_LONG).show();
                }
            }
        });
    }
